...
/// <summary>
/// A Winforms control to allow radio button behavior with checkable items in the toolstrip.
/// Source: http://msdn.microsoft.com/en-us/library/ms404318.aspx
/// </summary>
public class ToolStripRadioButtonMenuItem : ToolStripMenuItem
{
    ...
    //        // ---
    //        // Note: The checkbox is essentially mandatory: setting the checkstate on paint raises
    //        // unwanted events
